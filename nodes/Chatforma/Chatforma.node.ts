...
//import { toDisplayName } from '../QuickBooks/GenericFunctions';
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		if (resource === 'send') {
			...
			if (operation === 'segment_dispatch') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/segments/${list_id}/dispatch`,
					json: true,
				};
			...
			if (operation === 'dispatch') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/dispatch/user/${user_id}`,
					json: true,
				};
			...
			if (operation === 'message_to_dialog') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/dialogs/${user_id}/message`,
					json: true,
				};
			...
			if (operation === 'message') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/user/${user_id}/message/${message_id}`,
					json: true,
				};
		...
		if (resource === 'get') {
			...
			if (params === 'bots') {
				...
				const options: OptionsWithUri = {
					...
					method: 'GET',
					uri: `https://api.pro.chatforma.com/public/v1/bots/`,
					json: true,
				};
			...
			if (params === 'forms') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/forms/`,
					json: true,
				};
			...
			if (params === 'lists') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/segments`,
					json: true,
				};
			...
			if (params === 'users') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/users`,
					json: true,
				};
			...
			if (params === 'dialogs') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/dialogs/users`,
					json: true,
				};
			...
			if (params === 'dialogs_messades') {
				...
				const options: OptionsWithUri = {
					...
					uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/dialogs/${user_id}/messages`,
					json: true,
				};
		...
		if (resource === 'add') {
			...
			const options: OptionsWithUri = {
				...
				uri: `https://api.pro.chatforma.com/public/v1/bots/${bot_id}/segments/${list_id}/users`,
				json: true,
			};
